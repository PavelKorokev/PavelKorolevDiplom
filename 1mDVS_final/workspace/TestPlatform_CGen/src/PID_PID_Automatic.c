...
#define cPID_Max_VAL (self->PID_PID_Automatic_CAL_MEM->cPID_Max)
#define cPID_Min_VAL (self->PID_PID_Automatic_CAL_MEM->cPID_Min)
...
/******************************************************************************
 * BEGIN: DEFINITION OF METHOD 'PID_PID_Automatic_p_method'
 * ----------------------------------------------------------------------------
 * model name:...................................'p_method'
 * memory class:.................................'CODE'
 * ---------------------------------------------------------------------------*/

float32 PID_PID_Automatic_p_method ( const struct PID_PID_Automatic * self)
{
   return afterP_VAL;
}
/* ----------------------------------------------------------------------------
 * END: DEFINITION OF METHOD 'PID_PID_Automatic_p_method'
 ******************************************************************************/
...
float32 PID_PID_Automatic_Regulator (
   ...
   )
{
   ...
   _t1real32 = afterP_VAL + afterI_VAL + afterD_VAL;
   _t1real32 = ((cPID_Min_VAL >= _t1real32) ? cPID_Min_VAL : _t1real32);
   return ((_t1real32 <= cPID_Max_VAL) ? _t1real32 : cPID_Max_VAL);
}
/* ----------------------------------------------------------------------------
